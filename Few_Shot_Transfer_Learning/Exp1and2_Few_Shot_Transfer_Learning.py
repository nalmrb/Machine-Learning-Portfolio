...
def main(main_params={}):
    ...
    #define paths
    paths = define_paths_exp1and2.main(use_exp1_data)
    ...
    for loop_iter in range(num_loops):
        ...
        if initial_training == 1:
            ...
            #import
            from tools_exp1and2 import Sup_Learning_EEG_Data_Keras
            from tools_exp1and2 import plot_metrics_from_hist
        ...
        if quantization == 1:
            ...
            #quantize model
            from tools_exp1and2 import quantize_model
            quant_ints = [8, 8, 1]
        ...
        if few_shot_learning == 1:
            ...
            from tools_exp1and2 import get_dataset
            from tools_exp1and2 import plot_metrics, estimate_spikes, estimate_num_neurons
            from tools_exp1and2 import edge_learning, get_prelim_performance
            from akida import AkidaUnsupervised
            from akida import FullyConnected
            from tools_exp1and2 import get_inf_times_and_energy
